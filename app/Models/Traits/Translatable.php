...
trait Translatable
{
    ...
    protected function isKeyALocale($key)
    {
        ...
        return in_array($key, $locales, true);
    }
    ...
    protected function getLocales()
    {
        ...
        if (empty($localesConfig)) {
            throw new \Exception('Please make sure you have run "php artisan config:publish dimsav/laravel-translatable" '.
    ...
    public function toArray()
    {
        ...
        foreach ($this->translatedAttributes as $field) {
            if (in_array($field, $hiddenAttributes, true)) {
                continue;
            }
