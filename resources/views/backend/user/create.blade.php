...
@section('header-description', trans('labels.backend.users.titles.create'))
            ...
            <div class="box box-info">
                ...
                {{ Form::open(['route' => 'admin.user.store', 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'POST']) }}
                    ...
                    <div class="box-footer">
                        <div class="pull-left">
                            <a href="{{ route('admin.user.index') }}" class="btn btn-danger btn-xs">@lang('buttons.backend.back')</a>
                        </div>
                        <div class="pull-right">
                            {{ Form::submit(trans('buttons.backend.create'), ['class' => 'btn btn-success btn-xs']) }}
                        </div>
                    </div>
                    <!-- /.box-footer -->
                {{ Form::close() }}
