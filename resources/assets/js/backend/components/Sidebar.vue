    ...
    <div class="sidebar">
        <nav class="sidebar-nav">
            <ul class="nav">
                ...
                <template v-if="this.$app.user.can('view form_submissions') || this.$app.user.can('view form_settings')">
                    <li class="nav-title">{{ $t('labels.backend.sidebar.forms') }}</li>
                    <li class="nav-item" v-if="this.$app.user.can('view form_submissions')">
                        <router-link to="/form-submissions" class="nav-link">
                            <i class="icon-list"></i> {{ $t('labels.backend.form_submissions.titles.main') }}
                        </router-link>
                    </li>
                    <li class="nav-item" v-if="this.$app.user.can('view form_settings')">
                ...
                <template v-if="this.$app.user.can('create users') || this.$app.user.can('view users') || this.$app.user.can('view roles')">
                    ...
                    <li class="nav-item" v-if="this.$app.user.can('view roles')">
                ...
                <template v-if="this.$app.user.can('create metas') || this.$app.user.can('view metas') || this.$app.user.can('view redirections')">
                    ...
                    <li class="nav-item" v-if="this.$app.user.can('view redirections')">
