...
Route::group(
  ...
  function () {
      ...
      Route::get('/legal-mentions', 'FrontendController@legalMentions')->name(
        'legal-mentions'
      );
  }
);
  ...
  function () {
      ...
      Route::group(
        ...
        function () {
            ...
            Route::get('user/{user}/login-as', 'UserController@loginAs')->name(
              'user.login-as'
            );
        }
      );
      ...
      Route::patch('profile/update', 'UserController@profileUpdate')->name(
        'profile.update'
      );
